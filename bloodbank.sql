...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 15, 2018 at 07:25 PM
...
--
ALTER TABLE `donorregistration`
  ADD CONSTRAINT `donorregistration_ibfk_1` FOREIGN KEY (`bg_id`) REFERENCES `bloodgroup` (`blood_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
